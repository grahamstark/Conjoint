...
using DataFrames, CSV, Measurements, PlutoUI, CairoMakie


# ╔═╡ 982fd4ab-7393-40e2-9450-b6845f1bd174

const MPROBS = CSV.File( "../data/marginalprobabilities.csv" ) |> DataFrame


# ╔═╡ 289accff-c3d2-44d7-ad7f-81934abbf2d7
feats = unique( MPROBS.feature )

# ╔═╡ c3ee00e3-1fc4-4d25-8c40-e9aa84a5bb15


# ╔═╡ aea60406-f814-42ee-9d61-7508027d9656
begin

	
	fun = MPROBS[:level .== tax,:funding]
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "4a042faaceed272d253bdc0a11fdc00fd9bcc050"
